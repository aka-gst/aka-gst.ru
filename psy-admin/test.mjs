...
assert.match(widgetSource, /Официальная страница оплаты/);
...
assert.match(widgetCss, /\.psy-widget-actions \{ display: grid; grid-template-columns: repeat\(2, minmax\(0, 1fr\)\); gap: 8px; \}/);
assert.match(widgetCss, /\.psy-widget\[data-fullscreen="true"\] \.psy-widget-actions/);
assert.match(widgetCss, /\.psy-widget-payment \{[^}]*min-height: 58px;/);
assert.match(widgetCss, /\.psy-widget-booking \{[^}]*min-height: 58px;/);
