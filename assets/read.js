...
(() => {
  ...
  // По умолчанию раскрыт САМЫЙ СВЕЖИЙ сборник — теперь он первый: порядок
  // вывода перевёрнут по просьбе владельца, свежие сверху. Раскрывать
  // что-то надо обязательно, иначе первый экран — три картинки и ни одного
  // текста, а человек пришёл читать.
  раскрыть(сборники[0]);
