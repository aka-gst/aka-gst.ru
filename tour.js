/*
  ...
  ВНИМАНИЕ, если игра — PWA. Положив этот файл в офлайн-кэш service worker,
  вы получаете правки с опозданием на один запуск: SW отдаёт из кэша раньше,
  чем спрашивает сеть, и заголовки Caddy до этого решения не доходят. Игрок,
  зашедший однажды и закрывший, увидит старую версию. При выкладке правок
  поднимайте версию своего кэша.
*/
(function (global) {
  'use strict';
